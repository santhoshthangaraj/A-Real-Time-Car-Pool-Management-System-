...
public class CancelTripByHitchhiker extends Activity {
	private static final String DELETION_URL = "http://morningchronicles.com/android/deleteHitchhikerPlanTrip.php";
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.canceltripbyhitchhiker);

}
	public void coCancelHHTrip(View V)
	{
		
		
		System.out.println("Inside insert details delete details hh!!");
		...
		class DeleteFromDatabase extends AsyncTask<String, String, String> {
			...
			protected void onPreExecute() {
				super.onPreExecute();
				pDialog = new ProgressDialog(CancelTripByHitchhiker.this);
			...
			protected void onPostExecute(String file_url) {
				...
				pDialog.dismiss();
				if (file_url != null) {
					Toast.makeText(CancelTripByHitchhiker.this, file_url, Toast.LENGTH_LONG).show();
				}
