...
public class ChangeRouteByCarowner extends Activity {

	private static final String INSERTION_URL = "http://morningchronicles.com/android/updateCarOwnerPlanTrip.php";
...
protected void onCreate(Bundle savedInstanceState) 
{
        ...
        setContentView(R.layout.change_route);
...
public void coChangeTrip(View V)	
{
...
class InsertToDatabase extends AsyncTask<String, String, String> {
	...
	protected void onPreExecute() {
		super.onPreExecute();
		pDialog = new ProgressDialog(ChangeRouteByCarowner.this);
	...
	protected void onPostExecute(String file_url) {
		...
		pDialog.dismiss();
		if (file_url != null) {
			Toast.makeText(ChangeRouteByCarowner.this, file_url, Toast.LENGTH_LONG).show();
		}
